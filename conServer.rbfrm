#tag Window
Begin ContainerControl conServer
   AcceptFocus     =   ""
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   16777215
   ...
   Begin canLabel canLabel2
      ...
      Width           =   129
   End
   Begin CheckBox chkPublishToTracker
      AutoDeactivate  =   True
      Bold            =   ""
      Caption         =   "Publish To Tracker"
      DataField       =   ""
      DataSource      =   ""
      Enabled         =   True
      Height          =   20
...
#tag Events btnLogin
	...
	#tag Event
		Sub Clicked()
		  ...
		  myServer.Port = txtPort.Text.Val
		  myServer.Listen
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnCancel
	...
	#tag Event
		Sub Clicked()
		  frmMain.myConServer.Visible = false
